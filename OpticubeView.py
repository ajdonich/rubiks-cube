...
from Opticube import SIDES, WHITE_CB, W, ORANGE_CB, O, GREEN_CB, G, RED_CB, R, BLUE_CB, B, YELLOW_CB, Y
...
#{
    ...
    #{
        ...
        for side in SIDES:
            ...
            rects.extend(self.get_plot_rects(np.reshape(self.opt_cube.get_colors(side), (3,3)), anchor, mask))
